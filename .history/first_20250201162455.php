            ...
            <div class="container">
                <div class="row">
                    ...
                    <aside class="col-lg-3 text-right">
                        ...
                        <ul>
                            <li><a href="index.php">الصفحة الرئيسية <i class="fas fa-home"></i></a></li>
                            <li><a href="first.php">مرحلة أولى <i class="fas fa-tv"></i></a></li>
                            <li><a href="second.php">مرحلة ثانية <i class="fas fa-utensil-spoon"></i></a></li>
                            <li><a href="مhtmlرحلة ثالثة.">مرحلة ثالثة <i class="fas fa-pencil-alt"></i></a></li>
