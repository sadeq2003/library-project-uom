            ...
            <div class="container">
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="مرحلة اولى.html"> مرحلة اولى</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="مرحلة ثانية.html">مرحلة ثانية</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="مرحلة ثالثة.html">مرحلة ثالتة</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="مرحلة رابعة.html">مرحلة رابعة</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="login.php">مرحلة رابعة</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="admin.php">مرحلة رابعة</a>
                        </li>
                            ...
                            <div class="row">
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Economie/1.jpg"  class="d-block w-100" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Economie/2.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> إدارة البيوت</h3>
                                        <p>محمد فتحى</p>
                                        <a href="#">حمل الآن<i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Economie/3.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> صناعة اللبان</h3>
                                        <p>طارق مراد</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
