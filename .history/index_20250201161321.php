            ...
            <aside class="col-lg-3 mb-4">
                <div class="bg-white p-3 rounded shadow">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="index.phph" class="d-block p-2 mb-2">
                                <i class="fas fa-home mr-2"></i>Home
                            </a>
                        </li>
                        <li>
                            <a href="computer_science.phph" class="d-block p-2 mb-2">
                                <i class="fas fa-laptop mr-2"></i>Computer Science
                            </a>
                        </li>
                        <li>
                            <a href="hardware.phph" class="d-block p-2 mb-2">
                                <i class="fas fa-microchip mr-2"></i>Hardware
                            </a>
                        </li>
                        <li>
                            <a href="software.phph" class="d-block p-2 mb-2">
                                <i class="fas fa-code mr-2"></i>Software
                            </a>
                        </li>
                        <li>
                            <a href="networking.phph" class="d-block p-2 mb-2">
