        ...
        <section class="section-one text-center">
            <div class="container">
                <div class="content-me">
                    <h2>أهلاً بك فى عالم الحاسب الآلى</h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9  content-my-side text-right ">
                        <div class="computer">
                            <h2> قسم حاسب آلي<i class="fas fa-tv"></i> </h2>
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/4.jpg"  class="d-block w-100" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/5.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> Photo Shop 7</h3>
                                        <p>محمود كمال </p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/6.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>   Fundamentals </h3>
                                        <p>Team</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/7.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> Java</h3>
                                        <p>......</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/8.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> Java Netbeans</h3>
                                        <p>ماهر عبدالرحمن </p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/9.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> ميكروسوفت أكسيس 2016</h3>
                                        <p>ايهاب أبو العزم</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/10.jpg"  class="d-block w-100" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/13.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>مباديء الإحصاء </h3>
                                        <p>محمد صبحي</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/12.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>أمن المعلومات </h3>
                                        <p>فتحى على</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/14.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> لغة الجافا</h3>
                                        <p>على أبوضيف</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/16.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> C++</h3>
                                        <p>اسماعيل على</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/computer/17.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> PHP</h3>
                                        <p>أحمد أبو السعود</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
