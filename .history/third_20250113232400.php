...
<html lang="ar">
    ...
    <body>
            ...
            <div class="container">
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="حاسب الي.html">مرحلة اولى</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="اقتصاد.html">مرحلة ثانية</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="اعلام.html">مرحلة ثالتة</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="فنية.html">مرحلة رابعة</a>
                        </li>
                ...
                <div class="row">
                    ...
                    <aside class="col-lg-3 text-right">
                        ...
                        <ul>
                            ...
                            <li><a href="مرحلة اولى.html">مرحلةاولى<i class="fas fa-tv"></i></a></li>
                            <li><a href="مرحلة ثانية.html"> مرحلةثانية <i class="fas fa-utensil-spoon"></i></a></li>
                    ...
                    <div class="col-lg-9  content-my-side text-right ">
                        <div class="computer">
                            <h2> قسم  اعلام<i class="fas fa-tv"></i> </h2>
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/4.jpg"  class="d-block w-100" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/5.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> الإعلام الدولى</h3>
                                        <p>جيل خليل</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/6.jpg"  class="d-block w-100" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/7.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>الاعلام المحلى </h3>
                                        <p>طارق محمد</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/8.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> التخطيط الاعلامى</h3>
                                        <p>عبدالمجيد شكري</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/9.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>مقدمه فى الاعلان </h3>
                                        <p>....</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/10.jpg"  class="d-block w-100" alt="">
                                        </div>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/11.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>التحرير الصحفى </h3>
                                        <p>المهدي</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/12.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>الخبر الصحفى </h3>
                                        <p>حسني محمد</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/13.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>الرأى العام  </h3>
                                        <p>عاطف عدلى</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                ...
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/14.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3> فن كتابة المسرحية</h3>
                                        <p>رشاد رشدي</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <div class="box">
                                        ...
                                        <div class="img">
                                            <img src="img/Flags/15.jpg"  class="d-block w-100" alt="">
                                        </div>
                                        <h3>الكتابة للإزاعة والتلفزيون </h3>
                                        <p>بسمة أحمد</p>
                                        <a href="#">حمل الآن <i class="fas fa-arrow-left"></i></a>
                                    </div>
                                </div>
        ...
        <footer class="text-center">
            مشروع مكتبتي فرقة الرابعة 2020&copy;
        </footer>
