        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="stage 1.php">مرحلة أولى</a></li>
        ...
        <div class="row">
            ...
            <aside class="col-lg-3 mb-4">
                <div class="bg-white p-3 rounded shadow">
                    <h4 class="mb-3"><i class="fas fa-search mr-2"></i>Categories</h4>
                    <ul class="list-unstyled">
                        <li>
                            <a href="index.html" class="d-block p-2 mb-2">
                                <i class="fas fa-home mr-2"></i>Home
                            </a>
                        </li>
                        <li>
                            <a href="computer_science.html" class="d-block p-2 mb-2">
                                <i class="fas fa-laptop mr-2"></i>Computer Science
                            </a>
                        </li>
                        <li>
                            <a href="hardware.html" class="d-block p-2 mb-2">
                                <i class="fas fa-microchip mr-2"></i>Hardware
                            </a>
                        </li>
                        <li>
                            <a href="software.html" class="d-block p-2 mb-2">
                                <i class="fas fa-code mr-2"></i>Software
                            </a>
                        </li>
                        <li>
                            <a href="networking.html" class="d-block p-2 mb-2">
            ...
            <div class="col-lg-9">
                <div class="row">
                    <?php
                    // تعديل الاستعلام ليتم ترتيب الكتب حسب اسم الكتاب تصاعدياً
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo '<p class="text-center">لا توجد كتب متاحة حالياً.</p>';
                    }
                    ?>
                </div>
            </div>
