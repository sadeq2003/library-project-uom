...
<section id="container">
    ...
    <div class="sidebar">
        <ul>
            ...
            <li><a href="admin.php"><i class="fa-solid fa-book-open"></i> إدارة الكتب</a></li>
    ...
    <div class="main-content">
        ...
        <table class="books-table">
            ...
            <tbody>
                ...
                // التأكد من وجود بيانات في الجدول قبل عرضها
                ...
                <?php 
                    ...
                    echo "<tr><td colspan='9' class='no-records'>لا توجد كتب لعرضها</td></tr>";
                }
                ?>
            </tbody>
        </table>
